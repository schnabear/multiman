...
int Fonts_OpenFonts( const CellFontLibrary*lib, Fonts_t* fonts, char* _app_usrdir )
{
	...
	
	{
		static struct {
			...
			{ 1, CELL_FONT_TYPE_ROUND_SANS_EUROPEAN_CJK_LATIN_SET },
			{ 1, CELL_FONT_TYPE_GOTHIC_SCHINESE_CJK_JP_SET },
			{ 1, CELL_FONT_TYPE_GOTHIC_TCHINESE_CJK_JP_SET },
...
//				Fonts_PrintError( "   Fonts:cellFontOpenFontset=", ret );
	...
	
	{
		...
		static struct {
			...
			{ 0, "font4.ttf" }, //kristen
			{ 0, "fontA.ttf" }, //bank gothic
			{ 0, "fontB.ttf" }, //typewriter
			{ 0, "fontC.ttf" }, //monospaced
			{ 0, "fontD.ttf" }, //spiderman
			{ 0, "fontE.ttf" }, //arial narro
		};
